...
import main.model.plats.PlatEnfant;
import main.model.plats.PlatSante;
...
class PlatAuMenuTest {
    ...
    @Test
    void testToString() {
        Assertions.assertEquals("main.model.plats.PlatAuMenu{code=0, description='Plat', prix=1.0}\n", p.toString());
    }
